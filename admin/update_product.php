...
if(isset($_POST['update'])){
   ...
   $update_product = $conn->prepare("UPDATE `products` SET name = ?, category = ?, price = ?, detail = ?WHERE id = ?");
   ...
   if(!empty($image_01)){
      if($image_size_01 > 2000000){
         ...
         $message[] = 'image_01 updated successfully!';
      }
   }
...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <textarea name="detail" class="box" required cols="30" rows="10"><?= $fetch_products['detail']; ?></textarea>
      <div class="flex-btn">
